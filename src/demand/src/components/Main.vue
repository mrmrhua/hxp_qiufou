<template>
  <div>
    ...
    <div style="overflow:hidden;background:#f5f5f5;">
      <div style="height: 80px;background: rgb(255, 255, 255);border-top: 1px solid rgb(222, 222, 22);margin-bottom: 40px;">
  ...
  export default{
    ...
    methods: {
      ...
      getdemandcenterList(c, page) {
        var that = this;
        $.ajax({
          url: 'http://www.houxiaopang.com/api/v1.1/demandcenter',
          type: "GET",
