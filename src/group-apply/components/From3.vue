  ...
  <form style="padding: 0 32px 32px 32px" class="row">
    <div class="row">
      ...
      <div class="col-md-8 form-group form-right" style="padding-left: 15px">
        ...
        <input class="form-control" type="text" v-model="blog_url" placeholder="站酷、dribble、behance或其他案例展示页面">
      </div>
    </div>
    <div class="row">
      <p>为了尽可能完整真实地说明您的设计能力，请您上传至少三个已完成的商业作品案例。</p>
      <div class="col-md-2 form-group form-left">
        <label>案例图片</label>
  ...
  export default{
    ...
    methods: {
      ...
      submitapply(){
        ...
        var that = this;
        $.ajax({
          url: 'http://houxiaopang.com/api/v1.1/apply/companyform',
          type: 'post',
