                ...
                <form v-show="applystatus===0" class="row" id='form' role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group form-right parentCls">
                            <i class="iconfontyyy">&#xe61d;</i>
                            <input placeholder="请填写您的常用邮箱" name='email' type="text" data-validation="email"
                  ...
                  <div class="row">
                    ...
                    <p class="row_title" style="margin-top: 30px;">公司&nbsp;/&nbsp;工作室基本信息</p>
                    <div class="row">
                        <div class="col-md-2 form-group form-left">
                            <label>名　　称</label>
                        </div>
                        <div class="col-md-6 form-group form-right">
                            <i class="iconfontyyy">&#xe6f2;</i>
                            <input v-model='company_name' type="text" name='company_name' class="form-control"
                                   placeholder="请填写公司名称">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group form-right">
                            <i class="iconfontyyy">&#xe641;</i>
                            <input v-model='company_web' type="text" name='company_web' class="form-control"
                                   placeholder="选填">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group form-right">
                            <ul class="list-unstyled" style="margin-top: 15px">
                                ...
                                <li><input type="radio" value="3" name="company_size"><span class="lb">20-50人</span>
                                </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group form-right">
                            <i class="iconfontyyy">&#xe664;</i>
                            <input class="form-control" type="text" v-model="blog_url"
                                   placeholder="站酷、dribble、behance或其他案例展示页面">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2 form-group form-left">
    ...
    export default {
        ...
        methods: {
            ...
            submitfrom(){
                ...
                var that = this;
                _czc.push(["_trackEvent", '企业－提交申请', '申请']);
                $.ajax({
                    url: 'http://www.houxiaopang.com/api/v1.1/apply/companyform_new',
                    type: 'post',
                    ...
                    data: {
                        ...
                        role: $.trim(that.role),
                        company_web: $.trim(that.company_web),
                        company_name: $.trim(that.company_name),
                        company_size: $.trim(that.company_size),
                    },
                    timeout: 5000,    //超时时间
                    dataType: 'json',
