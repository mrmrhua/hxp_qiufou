<template>
  <div>
    <div class="img_head">
      <img class="info_bg" src="http://image.houxiaopang.com/workdetail/bg.png">
      <div class="fg"></div>
    </div>
    ...
    <div v-for="item in albums">
      <router-link tag="div" :to="{'path':'/album','query':{'album_id':item.work_id,'user_id':userid}}" class="worklist">
        <div class="left">
          <x-img :src="item.cover" style="width: 100%;display: block" :offset="50"></x-img>
        </div>
        <div class="right">
